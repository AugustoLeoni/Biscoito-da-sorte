...
const cookie = document.querySelector('.card img')
const card = document.querySelector('.card')
const cardOpen = document.querySelector('.card-opened')
const button = document.querySelector('button')
const text = document.querySelector('.card-opened p')

cookie.addEventListener('click',() => {
  card.classList.add('hide')
  cardOpen.classList.remove('hide')

  text.innerHTML = list[randomNumber()]
})
